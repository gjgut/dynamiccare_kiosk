...
public class Commands {
    ...
    protected static boolean withChecksum=true;
     ...
     public static byte[] BWMode(String Mode, String Kind){ return getFullCommand(true,"CMD"+Mode+Kind).getBytes();}
    public static byte[] Connect(){ return getFullCommand(true,"CON"+"00000000000").getBytes();}
    ...
    public static byte[] Position(String direction){ return getFullCommand(true,"CPS"+direction).getBytes();}
    ...
    public static byte[] ExcerciseSetting(String Mode, String weight, String count, String rData){ return getFullCommand(true,"CET"+TrimParameter(Mode,"00")+TrimParameter(weight,"010")+TrimParameter(count,"010")+TrimParameter(rData,"03")).getBytes();}
    public static byte[] ExcerciseStart(String Mode, String weight, String count, String set){ return getFullCommand(true,"CES"+TrimParameter(Mode,"00")+TrimParameter(weight,"010")+TrimParameter(count,"010")+TrimParameter(set,"03")).getBytes();}
    public static byte[] ExcerciseReady(String Mode, String weight, String count, String set){ return getFullCommand(true,"CER"+TrimParameter(Mode,"00")+TrimParameter(weight,"010")+TrimParameter(count,"010")+TrimParameter(set,"03")).getBytes();}
    public static byte[] ExcercisePause(String Mode, String weight, String count, String rData){ return getFullCommand(true,"CEU"+TrimParameter(Mode,"00")+TrimParameter(weight,"000")+TrimParameter(count,"000")+TrimParameter(rData,"03")).getBytes();}
    public static byte[] ExcerciseStop(String Mode, String weight, String count, String set){ return getFullCommand(true,"CEP"+TrimParameter(Mode,"00")+TrimParameter(weight,"000")+TrimParameter(count,"000")+TrimParameter(set,"03")).getBytes();}
    public static byte[] MeasureLevelCheck(String data){ return getFullCommand(false,"CLV"+data).getBytes();}
    ...
    public static byte[] MeasureReady(String max, String time){ return getFullCommand(true,"CRY"+TrimParameter(max,"005")+TrimParameter(time,"005")).getBytes();}
